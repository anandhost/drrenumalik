                        ...
                        <ul class="list-inline menu-left mb-0">
                            ...
                            <li>
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active">Welcome to Dr Shruti Malik  Dashboard !</li>
                                    </ol>
                                </div>
                            </li>
                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="row" style="width:100%";>
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title">Appointment Form Dashboard</h4>
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th>ID</th>
                                        ...
                                        if ($resultt->num_rows > 0) {
                                            ...
                                            while($row = $resultt->fetch_assoc()) {
                                                echo "<tr><td> ".$row['id']. "</td><td> ".$row['name']. "</td><td> ".$row['email']. "</td><td> ".$row['phone']. "</td><td> ".$row['date']."</td></tr>" ; 
                                            }
                                        }
